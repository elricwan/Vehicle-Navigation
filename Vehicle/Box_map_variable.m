function [xx,emptyVRoad] = Box_map_variable(N,Longest_subsegment,total_step,Segment,Dest,Dest_seg,Start,Start_seg) 
...
gM=repmat(g,1,1,total_step);
[iis,jjs] = find(gM==1);

sre = sparse(iis,jjs,binvar(length(iis),1),N,Longest_subsegment*total_step);

xx = reshape(sre,N,Longest_subsegment,total_step);